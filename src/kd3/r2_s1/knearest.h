...
#ifndef MPBLOCKS_KD_TREE_R2_S1_KNEAREST_H_
#define MPBLOCKS_KD_TREE_R2_S1_KNEAREST_H_
...
class KNearest : public NearestSearchIface<Traits> {
 public:
 ...
 public:
  ...
  // expose the distance object
  Distance_t& distFn() { return m_dist2Fn; }
