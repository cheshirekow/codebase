...
struct Simplex2 {
  ...
  Simplex2(PointRef pNull, SimplexRef sNull) : iPeak(0), o(0) {
...
template <class Traits>
struct Facet2 : std::vector<typename Traits::PointRef> {};
...
struct NeighborIterator {
  ...
  NeighborIterator(Simplex& S, uint32_t nIdx) : m_S(S), m_nIdx(nIdx) {}
...
struct VertexIterator {
  ...
  VertexIterator(Simplex& S, uint32_t nIdx) : m_S(S), m_nIdx(nIdx) {}
...
struct SimplexOps {
  ...
  void vsetSplit(Simplex& Sa, Simplex& Sb, Output1 a_only, Output2 b_only,
                 Output3 intersect);
  ...
  Surrogate<SimplexRef> setNeighbor(Simplex& S,
                                    uint32_t i);  ///< set neighbor i
  Surrogate<SimplexRef> setNeighborAcross(
      Simplex& S, PointRef v);                    ///< set neighbor across v
