...
class Shader : public GLuintRef {
 ...
 public:
  ...
  static RefPtr<Shader> CreateFromFile(GLenum, const char* filename);

  /// create a new shader from a source code string
  static RefPtr<Shader> CreateFromString(GLenum, const char* src);
};

}  // namespace gltk

#endif // GLTK_SHADER_H_
