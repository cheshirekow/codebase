...
#ifndef MPBLOCKS_POLYNOMIAL_DIFFERENCE_H_
#define MPBLOCKS_POLYNOMIAL_DIFFERENCE_H_
...
{
    typedef Difference<Scalar,Exp1,Exp2> Difference_t;
    return Difference_t(
