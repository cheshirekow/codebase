 ...
 */
/**
 *  \file   mpblocks/dubins/curves/SolutionLRLb.hpp
 *
 *  \date   Oct 30, 2012
...
#ifndef MPBLOCKS_DUBINS_CURVES_CUDA2_SOLUTION_LRL_B_HPP_
#define MPBLOCKS_DUBINS_CURVES_CUDA2_SOLUTION_LRL_B_HPP_
...
template <typename Format_t>
__host__ __device__ Result<Format_t> Solver<LRLb,Format_t>::solve(
        const Vector3d_t& q0,
        const Vector3d_t& q1,
        const Format_t r )
{
...
template <typename Format_t>
__host__ __device__ Result<Format_t> Solver<LRLb,Format_t>::solve_debug(
        const Vector3d_t& q0,
        const Vector3d_t& q1,
        const Format_t r,
            DebugResult& out )
