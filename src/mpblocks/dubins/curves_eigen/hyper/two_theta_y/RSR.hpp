...
#ifndef MPBLOCKS_DUBINS_CURVES_EIGEN_HYPER_TWO_THETA_Y_RSR_H_
#define MPBLOCKS_DUBINS_CURVES_EIGEN_HYPER_TWO_THETA_Y_RSR_H_
...
#endif  // MPBLOCKS_DUBINS_CURVES_EIGEN_HYPER_TWO_THETA_Y_RSR_H_
