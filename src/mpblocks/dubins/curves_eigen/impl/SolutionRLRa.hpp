...
#ifndef MPBLOCKS_DUBINS_CURVES_EIGEN_SOLUTION_RLR_A_HPP_
#define MPBLOCKS_DUBINS_CURVES_EIGEN_SOLUTION_RLR_A_HPP_
...
struct Solver<RLRa, Scalar> {
  ...
  static Path<Scalar> solve(const Vector3d& q0, const Vector3d& q1,
    ...
    Scalar a0 = rightAngleOf(q0);          //< arc location of q0
    Scalar a1 = std::atan2(dc[1], dc[0]);  //< arc location of tangent
...
#endif  // MPBLOCKS_DUBINS_CURVES_EIGEN_SOLUTION_RLR_A_HPP_
