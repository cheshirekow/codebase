 ...
 */
/**
 *  @file   pblocks/cuda/linalg2/Difference.h
 *
 *  @date   Dec 9, 2012
...
#ifndef MPBLOCKS_CUDA_LINALG2_DIFFERENCE_H_
#define MPBLOCKS_CUDA_LINALG2_DIFFERENCE_H_
...
class Difference:
    public RValue< Scalar, ROWS, COLS, Difference< Scalar, ROWS, COLS, Exp1, Exp2> >
{
    Exp1 const& m_A;
    Exp2 const& m_B;
...
Difference< Scalar, ROWS, COLS, Exp1, Exp2 >
    operator-( RValue<Scalar,ROWS,COLS,Exp1> const& A,
               RValue<Scalar,ROWS,COLS,Exp2> const& B )
{
    return Difference< Scalar, ROWS, COLS, Exp1,Exp2 >(
