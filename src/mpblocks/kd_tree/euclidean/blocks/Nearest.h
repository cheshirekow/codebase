 ...
 */
/**
 *  @file   mpblocks/kd_tree/euclidean/blocks/Nearest.h
 *
 *  @date   Nov 20, 2012
...
#ifndef MPBLOCKS_KD_TREE_EUCLIDEAN_BLOCKS_NEAREST_H_
#define MPBLOCKS_KD_TREE_EUCLIDEAN_BLOCKS_NEAREST_H_
...
class Nearest
{
    public:
        ...
        typedef euclidean::Nearest<Traits>   Search_t;
