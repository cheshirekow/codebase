 ...
 */
/**
 *  @file   mpblocks/kd_tree/euclidean/blocks/KNearest.h
 *
 *  @date   Nov 20, 2012
...
#ifndef MPBLOCKS_KD_TREE_EUCLIDEAN_BLOCKS_KNEAREST_H_
#define MPBLOCKS_KD_TREE_EUCLIDEAN_BLOCKS_KNEAREST_H_
...
class KNearest
{
    public:
        ...
        typedef euclidean::KNearest<Traits,Allocator>   Search_t;
