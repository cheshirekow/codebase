...
#ifndef MPBLOCKS_LINALG_AXISANGLE_H_
#define MPBLOCKS_LINALG_AXISANGLE_H_
...
class CoordinateAxis
    : public linalg::_RValue<Scalar, CoordinateAxis<Scalar, Axis> > {
 public:
...
#endif  // MPBLOCKS_LINALG_AXISANGLE_H_
