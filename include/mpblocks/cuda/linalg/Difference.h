 ...
 */
/**
 *  @file   pblocks/cuda/linalg/Difference.h
 *
 *  @date   Dec 9, 2012
...
#ifndef MPBLOCKS_CUDA_LINALG_DIFFERENCE_H_
#define MPBLOCKS_CUDA_LINALG_DIFFERENCE_H_
...
class Difference :
    public RValue<Scalar, Difference<Scalar,Exp1,Exp2> >
{
    Exp1 const& m_A;
    Exp2 const& m_B;
...
template <typename Scalar, class Exp1, class Exp2>
__device__ __host__
Difference<Scalar,Exp1,Exp2> operator-(
        RValue<Scalar,Exp1> const& A, RValue<Scalar,Exp2> const& B )
{
    return Difference<Scalar,Exp1,Exp2>(
