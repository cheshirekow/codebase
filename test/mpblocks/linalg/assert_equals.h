...
#ifndef TEST_LINALG_ASSERT_EQUALS_H_
#define TEST_LINALG_ASSERT_EQUALS_H_
...
testing::AssertionResult AssertMatrixEquality(
    ...
    const mpblocks::linalg::_RValue<Scalar, MatA>& A,
    const mpblocks::linalg::_RValue<Scalar, MatB>& B) {
...
#endif  // TEST_LINALG_ASSERT_EQUALS_H_
